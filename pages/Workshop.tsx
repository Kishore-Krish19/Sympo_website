  ...
  return (
    <div className="min-h-screen pt-24 px-4 container mx-auto flex items-center justify-center">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-mech text-white mb-2">WORKSHOP</h1>
        <h2 className="text-2xl md:text-3xl font-mech text-neonOrange mb-8">{WORKSHOP_INFO.topic}</h2>

        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="space-y-6">
             <div className="flex items-center gap-4 text-gray-300">
                <User className="text-neonBlue" />
                <span className="font-body text-xl">{WORKSHOP_INFO.trainer}</span>
             </div>
             <div className="flex items-center gap-4 text-gray-300">
             ...
             <div className="flex items-center gap-4 text-gray-300">
                ...
                <span className="font-body text-xl">{WORKSHOP_INFO.time}</span>
             </div>
          </div>

          <div className="bg-white/5 p-6 rounded-lg border border-white/10">
            <h3 className="text-white font-mech mb-4 uppercase tracking-widest">Key Benefits</h3>
        ...
        <Link to="/register/workshop" className="block text-center">
          <button className="w-full md:w-auto px-12 py-4 bg-neonOrange text-black font-mech font-bold text-xl rounded hover:bg-white transition-colors shadow-[0_0_20px_#ffaa00]">
